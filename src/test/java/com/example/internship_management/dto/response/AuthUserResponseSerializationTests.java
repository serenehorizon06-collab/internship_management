...
class AuthUserResponseSerializationTests {

	private final ObjectMapper objectMapper = new ObjectMapper();

	@Test
	void authUserResponseDoesNotExposePasswordHash() throws Exception {
		User user = new User();
		user.setUserId(1);
		...
		JsonNode json = objectMapper.readTree(objectMapper.writeValueAsString(AuthUserResponse.from(user)));
